        ...
        <div class="main-header-right">
            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    <a class="profile-user d-flex" href=""><img alt="" src="{{ Auth::user()->image ? Auth::user()->image :'/images/profile/profile6.png' }}"></a>
                    <div class="dropdown-menu">
                        <div class="main-header-profile bg-primary p-3">
                            <div class="d-flex wd-100p">
                                <div class="main-img-user"><img alt="" src="{{ Auth::user()->image ? Auth::user()->image :'/images/profile/profile6.png' }}" class=""></div>
                                <div class="ml-3 my-auto">
                                    <h6>{{ Auth::user()->first_name }} {{ Auth::user()->last_name }}</h6><span></span>
                                </div>
                            </div>
                        </div>
                        <router-link class="dropdown-item" to="/profile"><i class="bx bx-user-circle"></i>Profile</router-link>
                        <!-- <a class="dropdown-item" href=""><i class="bx bx-cog"></i> Edit Profile</a>
                        <a class="dropdown-item" href=""><i class="bx bxs-inbox"></i>Inbox</a>
                        <a class="dropdown-item" href=""><i class="bx bx-envelope"></i>Messages</a>
                        <a class="dropdown-item" href=""><i class="bx bx-slider-alt"></i> Account Settings</a> -->
                        <a class="dropdown-item" href="page-signin.html" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
