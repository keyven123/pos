							...
							<div class="col-md-12 col-lg-12 col-xl-12 my-auto mx-auto wd-100p">
								<div class="container">
									<div class="row">
										...
										<h1 data-aos="fade-up" class="aos-init aos-animate">Become Partner Of Ours</h1>
								...
								<div class="row">
									<div class="col-md-10 col-lg-10 col-xl-9 mx-auto">
										<div class="card-sigin">
											<div class="mb-5 d-flex"> <a href="/"><img src="{{ asset(images/jollitea-6.jpg) }}" class="img-fluid" alt="pluckoo-logo"></a></div>
											<div class="card-sigin">
												<div class="main-signup-header">
												<!-- <div  class="d-flex justify-content-center"> -->
													<h2 style="color: #453BFF">Welcome back!</h2>
												<!-- </div> -->
                                                    ...
                                                    @csrf
                                                        ...
                                                        </div><button type="submit" class="btn btn-main-primary btn-block radius-border" style="background: #453BFF;">{{ __('Login') }}</button>
